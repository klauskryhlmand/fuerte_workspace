...
#include <FroboMsgs/accelerometer.h>
#include <FroboMsgs/gyroscope.h>
#include <FroboMsgs/magnetometer.h>
...
public:
	...
	void newMsgCallback(const fmMsgs::serial::ConstPtr& msg);
...
private:
	...
	fmMsgs::gyroscope msg_gyro_;
	fmMsgs::accelerometer msg_acc_;
	fmMsgs::magnetometer msg_mag_;
