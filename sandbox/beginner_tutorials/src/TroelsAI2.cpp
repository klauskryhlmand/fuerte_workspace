...
***********************************************************************************************/
				...
				if(ls_inf.force > 0)
				{
					...
					msg.speed_left -= ceil(ls_inf.force*Max_speed*2);
				}
				else
				{
					//obstacles to the right;
					msg.speed_right += ceil(ls_inf.force*Max_speed*2);
				}
				...
				if(msg.speed_left > Max_speed) msg.speed_left = Max_speed/4;
				if(msg.speed_right > Max_speed) msg.speed_right = Max_speed/4;
